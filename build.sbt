...
// Play 2.4
lazy val play24_monad = project.in(file("play24/play-monad")).settings(sharedSettings ++ Seq[Setting[_]](
  name := "play24-monad",
...
// Play 2.5
lazy val play25_monad = project.in(file("play25/play-monad")).settings(sharedSettings ++ Seq[Setting[_]](
  name := "play25-monad",
